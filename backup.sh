    ...
    while true; do
        ...
        case $choice in
            ...
            3)
                ...
                ;;
            4)
                print "Thank you for using @ACh1992 script. Goodbye!"
                exit 0
                ;;
            *)
...
discord_progress() {
    ...
    CAPTION="📦 **From** \`${ip}\` [by **[@ACh1992](https://t.me/ACh1992)**]\n➖➖➖➖**Sponsor**➖➖➖➖\n[${SPONSORTEXT}](${SPONSORLINK})"
    LIMITSIZE=24
...
EOF
            ...
            chmod 600 ~/.muttrc
            CAPTION="<html><body><p><b>📦 From </b><code>\${ip}</code> [by <b><a href='https://t.me/ACh1992'>@ACh1992</a></b>]</p><p><b>➖➖➖➖Sponsor➖➖➖➖</b></p><p><a href='${SPONSORLINK}'>${SPONSORTEXT}</a></p></body></html>"
...
EOL
    ...
    if bash "$BACKUP_PATH" 2>&1 | tee /tmp/backup.log; then
        ...
        success "Thank you for using @ACh1992 backup script. Enjoy automated backups!"
        exit 0
    else
